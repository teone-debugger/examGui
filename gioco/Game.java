...
import interfaccia.FrameSelection;
...
public class Game {
    ...
    public static boolean isWin(){
        return Dungeon.getDrago().getPuntiVita() <= 0 || Dungeon.getGiocatore().getMonete() >= 1000;
    }
    ...
    public void playTerminal() {
        ...
        new Dungeon(17, 81, 4, 8, createGiocatoreTerminal(), new Drago());
